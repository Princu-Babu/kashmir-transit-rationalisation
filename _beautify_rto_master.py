...
SRC = Path("E:/kash/outputs_v3.3.9/Kashmir_Route_Frequency_Plan_v3.3.9_RTO.xlsx")
DST = Path("E:/kash/outputs_v3.3.9/Kashmir_Route_Frequency_Plan_v3.3.9_RTO_Pretty.xlsx")
...
SRC_CSV = Path("E:/kash/outputs_v3.3.9/Rationalised_Routes_Kashmir_v3.csv")

# Also write a copy to a convenient location for the meeting
ALSO  = Path("C:/Users/Prash/Music/Kashmir_Route_Frequency_Plan_v3.3.9_RTO_Pretty.xlsx")
...
def main():
    ...
    sub = ws1.cell(row=4, column=2,
                    value=(f"Engine v3.3.9  ·  Generated "
