<p align="center">
  <img src="https://img.shields.io/badge/Engine-v3.1-1A237E?style=for-the-badge&logo=python&logoColor=white" alt="v3.1"/>
...
Srinagar's public transit network has grown organically over decades — 613+ registered minibus/bus permits operating on overlapping corridors with no centralised frequency plan. The result:
...
1. **Load & Geocode Routes** — Parse 613+ route permits from `existing-routes.csv` with flexible column aliasing
...
|---|---|---|
| `existing-routes.csv` | 613 bus route permits with origin/destination/via columns | 85 KB |
